...
namespace MalbersAnimations.HAP
{
    ...
    public partial class MWeaponManager
    {
        ...
        {
            if (WeaponIsActive) Weapon.MainAttack_Released(this);
        }
        ...
        {
            if (WeaponIsActive/* && RiderCanAttack*/)  Weapon.SecondaryAttack_Start(this);
        }

        public virtual void SecondAttackReleased()
        {
            if (WeaponIsActive) Weapon.SecondaryAttack_Released(this);
        }
        ...
        public virtual void ReloadWeapon()
        {
            ...
            {
                Aimer.ExitAim(); //Force Exit Aiming 
            }
        }
